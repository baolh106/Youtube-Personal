...
<body>
	<section>
		<div class="container">
			<div class="row">
				<form action="/Asm_Java_Youtube/youtube/share?videoid=${videoid}" method="post"
					class="form p-4 col-4 bg-white mt-2"
					style="margin: 0 auto; border-radius: 10px">
					<div class="form-header text-center mb-4">
						<h3 class="text-uppercase text-info font-weight-bold">Share Video</h3>
					</div>
					...
					<div class="form-footer w-100">
						<div class="change-page">
							<a href="/Asm_Java_Youtube/youtube/video">Back Home?</a>
						</div>
